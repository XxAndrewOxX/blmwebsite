...
function App() {
  ...
  return (
      <div className="App">
        <Favicon url="https://www.urbanprofile.com/images/products/secondary/black_power_fist_ladies_style-1.jpg" />
        <Helmet>
        ...
        <Container component="main" maxWidth="xs">
          ...
          <div className={classes.paper}>
            ...
            <div style={{fontSize: 36 , backgroundColor: "#234B05", borderRadius: 20, opacity: 0.75 }} >
              <h1 style={{fontSize: 36 , color: "white", textAlign: 'center' }} >
                Enter Your Information For Change
              </h1>
  ...
  function mailTo4(e) {
    e.preventDefault();
    window.open ("googlegmail:///co?to=hotline@cityofomaha.org&subject=Justice for James Scurlock&body=Hello, %0D%0A%0D%0A" +
        "\n\n" +
        "My name is "+firstName+" "+lastName+". I am a resident of "+location+" and I am emailing today to demand accountability for the murder of James Scurlock.\n%0D%0A%0D%0A" +
        "\n" +
        "Mr. Scurlock deserves justice and Jake Gardner must be charged and tried in order to determine whether he is guilty or not.%0D%0A%0D%0A\n" +
        "\n" +
        "The police and the Omaha justice department must make the right decision. Without charging this man, you may be letting a murderer walk free among the citizens of Omaha.%0D%0A%0D%0A\n" +
  ...
  function mailTo3(e) {
    e.preventDefault();
    window.open ("googlegmail:///co?to=mail_grams@grams.senate.gov&bcc=kit_bond@bond.senate.gov&subject=Justice for George Floyd&body= Hello, %0D%0A%0D%0A" +
        "\n\n" +
        ...
        "\n" +
        "I demand that Derek Chauvin's charge be upgraded to first degree murder.%0D%0A%0D%0A\n" +
        "\n" +
        "George Floyd should be alive today if it was not for the gross abuse of power and white supremacy exhibited by the Minneapolis Police Department. All officers involved must face severe consequences for this murder in order to provide his family with justice and prevent further cops from committing brutal acts of violence against our communities.%0D%0A%0D%0A\n" +
        "\n" +
        "In addition, I demand that we start providing more support towards community efforts and organizations outside of the police forces in order to prevent police brutality and violence in the future. %0D%0A%0D%0A\n" +
        "\n" +
        "Sincerely, \n%0D%0A" +
  ...
  function mailTo2(e) {
    e.preventDefault();
    window.open ("googlegmail:///co?to=Greg.Fischer@louisvilleky.gov&subject=Justice for Breonna Taylor&body=To whom it may concern,%0D%0A%0D%0A" +
        "\n" +
        "My name is "+firstName+" "+lastName+". I am from "+location+".\n%0D%0A%0D%0A" +
        "\n" +
        "I demand justice and accountability for the death of Breonna Taylor and I demand the charges be dropped against Kenneth Walker.\n%0D%0A%0D%0A" +
        "\n" +
  ...
  function mailTo1(e) {
    e.preventDefault();
    window.open ("googlegmail:///co?to=Greg.Fischer@louisvilleky.gov&subject=Justice for David McAtee&body=To Whom it may Concern,%0D%0A%0D%0A\n" +
        "\n" +
