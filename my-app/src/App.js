...
function App() {
      ...
      <div className="App">
        ...
        <Container component="main" maxWidth="xs">
          ...
          <div className={classes.paper}>
            ...
            <div style={{fontSize: 36 , backgroundColor: '#234B05', borderRadius: 20, opacity: 0.9}} >
            ...
            <form className={classes.form} noValidate>
              ...
              <TextField
                  ...
                  autoComplete="Where are you from?"
  ...
  function mailTo4(e) {
    e.preventDefault();
    window.open ("mailto:hotline@cityofomaha.org?subject=Justice for James Scurlock&body=Hello, %0D%0A%0D%0A" +
        "\n\n" +
  ...
  function mailTo3(e) {
    e.preventDefault();
    window.open ("mailto:mail_grams@grams.senate.gov?bcc=kit_bond@bond.senate.gov&subject=Justice for George Floyd&body=Hello, %0D%0A%0D%0A" +
        "\n\n" +
  ...
  function mailTo2(e) {
    e.preventDefault();
    window.open ("mailto:Greg.Fischer@louisvilleky.gov?subject=Justice for Breonna Taylor&body=To whom it may concern,%0D%0A%0D%0A" +
        "\n" +
        "My name is "+firstName+" "+lastName+". I am from "+location+".\n%0D%0A%0D%0A" +
        "\n" +
        "I demand justice and accountability for the death of Breonna Taylor.\n%0D%0A%0D%0A" +
        "\n" +
        ...
        "\n" +
        "This pattern of police brutality and the unjust loss of black life in this country will continue if serious action is not taken. I urge you to do the right thing and bring charges against the officers who took Breonna Taylor's life.\n%0D%0A%0D%0A" +
        "\n" +
        "In addition, I demand that we start providing more support towards community efforts and organizations outside of the police forces in order to prevent police brutality and violence in the future. %0D%0A%0D%0A\n" +
        "\n" +
        "Sincerely, %0D%0A"+
